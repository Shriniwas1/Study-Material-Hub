...
export const MenubarTrigger = React.forwardRef(({ className, ...props }, ref) => (
...
export const MenubarSubTrigger = React.forwardRef(({ className, inset, children, ...props }, ref) => (
...
export const MenubarSubContent = React.forwardRef(({ className, ...props }, ref) => (
...
export const MenubarContent = React.forwardRef(({ className, align = "start", alignOffset = -4, sideOffset = 8, ...props }, ref) => (
...
export const MenubarItem = React.forwardRef(({ className, inset, ...props }, ref) => (
...
export const MenubarCheckboxItem = React.forwardRef(({ className, children, checked, ...props }, ref) => (
...
export const MenubarRadioItem = React.forwardRef(({ className, children, ...props }, ref) => (
...
export const MenubarLabel = React.forwardRef(({ className, inset, ...props }, ref) => (
...
export const MenubarSeparator = React.forwardRef(({ className, ...props }, ref) => (
